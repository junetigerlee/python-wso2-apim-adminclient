...
from wso2_apim_adminclient.models.throttle_policy import ThrottlePolicy


class TestThrottlePolicy(unittest.TestCase):
    """ ThrottlePolicy unit test stubs """
    ...
    def testThrottlePolicy(self):
        """
        Test ThrottlePolicy
        """
        # FIXME: construct object with mandatory attributes with example values
        #model = wso2_apim_adminclient.models.throttle_policy.ThrottlePolicy()
        pass
