...
class APICollectionApi(object):
    ...
    def policies_mediation_get(self, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.policies_mediation_get(callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.policies_mediation_get_with_http_info(**kwargs)
        else:
            (data) = self.policies_mediation_get_with_http_info(**kwargs)
            return data

    def policies_mediation_get_with_http_info(self, **kwargs):
        """
        Retrieve/Search APIs 
        This operation provides you a list of available APIs qualifying under a given search condition.  Each retrieved API is represented with a minimal amount of attributes. If you want to get complete details of an API, you need to use **Get details of an API** operation. 
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.policies_mediation_get_with_http_info(callback=callback_function)
        ...
        all_params = ['limit', 'offset', 'query', 'accept', 'if_none_match']
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method policies_mediation_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api('/policies/mediation', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
